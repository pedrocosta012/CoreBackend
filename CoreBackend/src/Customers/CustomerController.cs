...
public sealed class CustomerController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IResult> Create([FromBody] CreateCustomerRequest request, [FromServices] IDbConnection db)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IResult> Update(string id, [FromBody] UpdateCustomerRequest request, [FromServices] IDbConnection db)
    {
